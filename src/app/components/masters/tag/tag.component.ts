    ...
    switch (this.dbops) {
      case DbOperation.create:
        this._httpService
          ...
          .subscribe((res) => {
            if (res.isSuccess) {
              this._toaster.success('Record Saved !!', 'Tag Master');
              this.resetForm();
            } else {
              this._toaster.error(res.error[0], 'Tag Master');
            }
          });
        break;
    ...
    this._httpService
      ...
      .subscribe((res) => {
        if (res.isSuccess) {
          ...
          this._toaster.error(res.errors[0], 'Tag Master');
        }
      });
  }
  Edit(id: number) {
      ...
      .then((result) => {
        if (result.isConfirmed) {
          this._httpService
            ...
            .subscribe((res) => {
              if (res.isSuccess) {
                // this._toaster.success('Record Deleted !!', 'Tag Master');
